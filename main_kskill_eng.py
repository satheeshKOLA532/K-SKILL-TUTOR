...
def main():
    ...
    st.title("let's connect with Englih Brains...")
    ...
    user_message = st.chat_input("learn english...")
    if user_message:
...
def process_text_message_eng(message):
    ...
    message = [{"role": msg["role"], "content": msg["content"]} for msg in chat_history]
    print("message before sending to run_qa() function:", message)
